...
# Examples
In examples/validate directory there is an example data that can be used to validate
...
a typical log file from 5GHz experiment.

The antabfs file ec071mtr.antabfs.orig is the antab file generated by the
original 20201123 version of the antab program. During generating this file, only
Tsys<20K data were removed and only for the bbc01. All other channels were not cleaned.
...
(antabTr.py) in the analogous way. The program have generated wisdom subdirectory
